...
class UsageEvent(models.Model):
    EVENT_TYPES = [
        ...
        ('random_beer', 'Random Beer Spin'),
        ('sixpack_generate', 'Sixpack Spin'),
        ('sixpack_checkout', 'Sixpack Checkout'),
        ('app_shop_view', 'View App Shop'),
        ('app_shop_checkout', 'App Shop Checkout'),
